            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item disabled-for-user">
                        <a class="nav-link active d-flex align-items-center" href="?view=ingreso"><ion-icon name="cube-outline"></ion-icon>&nbsp;Ingresar Activos</a>
                    </li>
                    <li class="nav-item disabled-for-user">
                        <a class="nav-link active d-flex align-items-center" href="?view=egreso"><ion-icon name="arrow-undo-circle-outline"></ion-icon>&nbsp;Retirar Activos</a>
                    </li>
                    <li class="nav-item">
